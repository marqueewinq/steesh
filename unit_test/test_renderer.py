...
@pytest.mark.parametrize(
    "deck_path,expected",
    [('unit_test/decks/happy/deck_3.txt', [('1', 'a'), ('1', 'b'), ('1', 'c')]), ('unit_test/decks/happy/deck_4.txt', [('1202020200202', 'sdmsfdopk'), ('6789789790', 'asjiasdidsa'), ('980898790', 'asjiasdi'), ('89078998999898', 'sadsadsasadkln'), ('877677667', 'biuashbuidsa'), ('87997898', 'sajiosdaioj')]), ('unit_test/decks/happy/deck_1.txt', [('2', 'Healer Dork'), ('1', 'Regrowth')]), ('unit_test/decks/happy/deck_2.txt', [('1', 'sdkmsa')]), ('unit_test/decks/happy/deck_0.txt', [('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction')])]
    )
...
def test_render_page_cli_happy(df_path, deck_path):
    with tempfile.TemporaryDirectory() as td:
        render_page_cli(df_path, deck_path, 'templates/test_card_template.html', os.path.join(td,'out.pdf'))
        assert PdfFileReader(os.path.join(td,'out.pdf')).getNumPages() == ceil(sum([int(pair[0]) for pair in read_deck(deck_path)])/9)
...
def test_render_page_cli_card_not_in_lib(df_path, deck_path):
    with pytest.raises(ValueError):
        render_page_cli(df_path, deck_path, 'templates/test_card_template.html','out.pdf')
