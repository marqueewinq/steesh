...
@pytest.mark.parametrize(
    "test_input,expected",
    [('test/decks/happy/deck_3.txt', [('1', 'a'), ('1', 'b'), ('1', 'c')]), ('test/decks/happy/deck_4.txt', [('1202020200202', 'sdmsfdopk'), ('6789789790', 'asjiasdidsa'), ('980898790', 'asjiasdi'), ('89078998999898', 'sadsadsasadkln'), ('877677667', 'biuashbuidsa'), ('87997898', 'sajiosdaioj')]), ('test/decks/happy/deck_1.txt', [('1','adfasfdfsfddafdfafsd')]), ('test/decks/happy/deck_2.txt', [('1', 'sdkmsa')]), ('test/decks/happy/deck_0.txt', [('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction'), ('2', 'Healer Dork'), ('1', 'Regrowth'), ('12', 'Vicious Reaction')])]
    )
...
@pytest.mark.parametrize(
    "test_input", 
    ['test/decks/wrong_regexp/deck_0.txt','test/decks/wrong_regexp/deck_1.txt','test/decks/wrong_regexp/deck_1.txt']
    )
...
@pytest.mark.parametrize(
    "test_input", 
    ['test/decks/wrong_regexp/deck_01212.txt','test/decks/wrong_regexp/deck_1121.txt','test/decks/wrong_regexp/...']
    )
...
@pytest.mark.parametrize(
    "test_input", 
    ['test/decks/wrong_regexp','test/decks/happy','test/decks']
    )
